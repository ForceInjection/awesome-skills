...
> 中文版：[SKILL.md](SKILL.md) — this is the English mirror of the Chinese `humanizer-zh` skill (adapted for Chinese prose; the Chinese edition replaces §17/§19/§26 with Chinese-specific equivalents).
...
This English file is the mirror of the Chinese `humanizer-zh` skill in this repo, itself a Chinese adaptation of [blader/humanizer](https://github.com/blader/humanizer) (MIT, Copyright (c) 2025 Siqi Chen). See the license in this directory.
